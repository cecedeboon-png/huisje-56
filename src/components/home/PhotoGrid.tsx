      ...
      <div className="container-content">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10">
          ...
          <Link
            ...
            className="mt-4 md:mt-0 inline-flex items-center gap-1.5 text-sm text-terracotta hover:text-terracotta-600 font-medium font-body transition-colors shrink-0"
          >
