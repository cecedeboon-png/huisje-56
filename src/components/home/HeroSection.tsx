    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container-content text-center text-white py-24">
        <div className="max-w-3xl mx-auto">
          ...
          {/* Headline */}
          <h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-normal leading-tight mb-6">
            {t('headline')}
          </h1>

          {/* Tagline */}
          <p className="font-display text-xl md:text-2xl font-normal text-white/90 italic mb-6">
            &ldquo;{t('tagline')}&rdquo;
          </p>

          {/* Subheadline */}
          <p className="font-body text-base md:text-lg text-white/80 leading-relaxed mb-10 max-w-2xl mx-auto">
            {t('subheadline')}
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm border border-white/30 text-white px-8 py-4 rounded-sm font-body font-medium text-base tracking-wide hover:bg-white/25 transition-all"
            >
              {t('ctaDiscover')}
            </Link>
          </div>
